<template>
  ...
  <div class="w-full py-60 px-20 flex items-center">
    <div class="container flex flex-col md:flex-row items-center justify-center px-5 text-gray-700">
      <div class="max-w-md">
        ...
        <button
          class="px-4 inline py-2 text-sm font-medium leading-5 shadow-md bg-red-500 text-white transition-colors duration-150 border border-transparent rounded-lg hover:bg-red-600"
